...
- (void)setCellWidth:(CGFloat)cellWidth{
    ...
    NSMutableAttributedString *attr = @"自动布局自动计算高度：<br>这是一个最好的时代，也是一个最坏的时代；这是明智的时代，这是愚昧的时代；这是信任的纪元，这是怀疑的纪元；这是光明的季节，这是黑暗的季节；这是希望的春日，这是失望的冬日；我们面前应有尽有，我们面前一<br>".yj_toHtmlMutableAttributedString;
    [attr yj_setFont:17];
